...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        ...
        case EQUIPMENT_SLOT_FEET: return  "鞋";// session->GetAcoreString(LANG_SLOT_NAME_FEET);
        case EQUIPMENT_SLOT_WRISTS: return  "手腕";// session->GetAcoreString(LANG_SLOT_NAME_WRISTS);
        case EQUIPMENT_SLOT_HANDS: return  "手部";// session->GetAcoreString(LANG_SLOT_NAME_HANDS);
